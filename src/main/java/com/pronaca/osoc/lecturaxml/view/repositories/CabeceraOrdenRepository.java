...
public interface CabeceraOrdenRepository extends JpaRepository<CabeceraOrden, Long> {
	...
	List<CabeceraOrden> findByNumeroOrden(String codigo);
	...
	List<CabeceraOrden> findByParametros(String fechaInicio, String fechaFin, String orden, String codProveedor, String empresa, String estado);
